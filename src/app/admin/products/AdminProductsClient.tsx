  ...
  if (items.length === 0) {
    return (
      <p className="text-sm text-[#a36d63]">
        No products yet. Click &ldquo;Add new product&rdquo; to create
        your first one.
      </p>
    );
  }
            ...
            <div className="relative w-full aspect-square bg-[#fff1f7]">
              ...
              <div className="absolute inset-x-2 bottom-2 flex justify-end gap-2">
                ...
                <button
                  ...
                  className="rounded-full bg-[#fee2e2]/90 px-3 py-1 text-[11px] font-medium text-[#b91c1c] shadow-sm hover:bg-[#fecaca]"
                >
